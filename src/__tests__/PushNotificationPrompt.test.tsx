...
describe("PushNotificationPrompt", () => {
  ...
  describe("subscribing", () => {
    ...
    it("shows the Mute notifications button after subscribing", async () => {
      stubPushSupport();
      const user = userEvent.setup();
      render(<PushNotificationPrompt />);
  ...
  describe("already subscribed state", () => {
    it("shows the Mute notifications button when a subscription already exists", async () => {
    ...
    it("clicking Mute calls subscription.unsubscribe and unsubscribeUser", async () => {
      ...
      await waitFor(() => screen.getByRole("button", { name: /mute notifications/i }));
      await user.click(screen.getByRole("button", { name: /mute notifications/i }));
    ...
    it("shows the prompt again after unsubscribing", async () => {
      stubPushSupport({ existingSub: MOCK_SUB });
      const user = userEvent.setup();
      render(<PushNotificationPrompt />);
